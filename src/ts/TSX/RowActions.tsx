  ...
  return (
    <div className="toolbar__item row-actions">
      <div className="row-actions__item">
        ...
        <button className="row-actions__confirm-button" onClick={() => store.addRow(store.userInputAddRow)}>OK</button>
      </div>
      <div className="row-actions__item">
        ...
        <input 
          ...
          type="text" 
          className="row-actions__input" />
        <button className="row-actions__confirm-button" onClick={() => store.multRow(store.userInputMultRow)}>OK</button>
      </div>
      <div className="row-actions__item">
        ...
        <input 
          ...
          type="text" 
          className="row-actions__input" />
        <button className="row-actions__confirm-button" onClick={() => store.swap(store.userInputSwapRows)}>OK</button>
      </div>
    </div>
  )
}
